...
useRouteMatch creates nested paths to matched objects. It allows access to data without Switch statements or a new <Route>

1. How would you explain form validation to someone who has never programmed before?

You know how when you create a password and it doesn't include the correct combination of numbers, characters and length? That is form validation at work behind the scenes. Those red errors when filling out an order are programmed to ake sure you enter the needed data and are actually a much more efficient way to collect the needed data or verify authenticity via passwords than a pen and paper.

1. In 1-2 sentences, define end to end testing.

It is testing to ensure that the flow of the application is without bugs. To validate a positive user experience and ensure data consistency and component functionality throughout the whole process.
